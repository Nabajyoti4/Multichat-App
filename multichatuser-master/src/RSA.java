...
public class RSA {
    ...
    public void generateKey(String name){
          try {
            File myObj = new File("C:\\Users\\Nabajyoti\\Downloads\\multichatuser-master (1)\\multichatuser-master\\Public Keys",name+".txt");
    ...
    */
    ...
    public byte[] encrypt(byte[] message, String name) {
      ...
      try {
          File myObj = new File("C:\\Users\\Nabajyoti\\Downloads\\multichatuser-master (1)\\multichatuser-master\\Public Keys",name);
